...
<div class="c"></div>	<div id="bd">
    <div id="ban-in" style="background-image:url(images/contacts.jpg)">
        ...
        <div class="wp">
            ...
            <div class="contact-l">
                <ul class="ul-contact">
                    ...
                    <li class="li3"><a href="mail:1063932362@qq.com">1063932362@qq.com</a></li>
                </ul>
            </div>
            <div class="contact-r">
                <!--<iframe scrolling="no" frameborder="0" src="guest.php" width="100%" height="235"></iframe>-->
                <form action="sct" class="contact-form" method="post">
                    <div class="">
                    ...
                    <textarea cols="30" rows="10" name="txt_con" id="txt_con" placeholder="您的留言仅网站管理员可见~"></textarea>
