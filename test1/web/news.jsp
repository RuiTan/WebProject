    ...
    <div class="wp">
        ...
        <div id="nav">
            <ul>
                ...
                <li><a href="news.jsp"  style="color:#e4392a; border-bottom:3px solid #e4392a;">艾玛动态</a></li>
...
<div id="fd" class="index-fd pr">
    ...
    <div class="fd-copy">
        <div class="wp">
            <p>
                <span>网络技术（北京）有限公司 Copyright&copy; 2007-2015 </span><a href=""><span>沪ICP备030xxxxx号</span></a> <a href=""></a>
            </p>
        </div>
    </div>
</div>
